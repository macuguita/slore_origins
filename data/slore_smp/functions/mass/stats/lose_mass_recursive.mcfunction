scoreboard players remove @s slore_smp.massStats.massResource2 1
scale subtract pehkui:visibility 0.02
scale subtract pehkui:height 0.02
scale subtract pehkui:width 0.02
execute if score @s slore_smp.massStats.massResource2 matches ..25 run scale add pehkui:hitbox_height 0.02
execute if score @s slore_smp.massStats.massResource2 matches ..25 run scale add pehkui:hitbox_width 0.02
